...
compile(function(){
  $("body").append("<my-modal><page-create></page-create></my-modal>")
})

directive("my-modal",function(){
  return {
    link : function( scope, ele, attrs){
      ele.find("[submit]").click(function(){
        attrs["onSubmit"]( ele.find('page-create').value() )
      })
    }
  }
})

.directive("page-create",function(){
