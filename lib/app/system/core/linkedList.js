...
linkedList.prototype.store = function(obj){
...
linkedList.prototype.resetHeadAndTail = function(){
  if( this.head == null ){
...
linkedList.prototype.before = function( obj, who ){
...
linkedList.prototype.after = function( obj, who ) {
...
linkedList.prototype.push = function( item, key, order){
...
linkedList.prototype.forEachSeries = function( handler, callback  ){
  var root = this
